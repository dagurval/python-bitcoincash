...
from bitcoincash.messages import msg_version, msg_verack, msg_addr, msg_alert, \
...
class Test_messages(unittest.TestCase):
    verackbytes = b'\xe3\xe1\xf3\xe8verack\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00]\xf6\xe0\xe2'
